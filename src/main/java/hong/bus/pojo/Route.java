...
public class Route extends RouteKey {
    ...
    public Route(Long pkId, String routeCode, String routeDetail, String creator, String createTime, String modifier, String modifyTime, String ts, Integer dr, String def01, String def02, String def03, String def04, String def05, String def06, String def07, String def08, String def09, String def10) {
        super(pkId, routeCode);
